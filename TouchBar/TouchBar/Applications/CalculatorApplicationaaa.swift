...
//
//        super.init(name: "com.flaw.touchBarApp.calculator", accentColor: .systemOrange)
...
//        if frame.width > superview!.frame.width {
//            pasteButton.frame.origin.x = frame.width - pasteButtonWidth
//            currentNumberLabel.frame.size.width = minNumberWidth
//            previousNumberLabel.frame.size = currentNumberLabel.animator().frame.size
//        } else {
//            pasteButton.frame.origin = CGPoint(x: superview!.frame.width - pasteButtonWidth, y: 0)
//            currentNumberLabel.frame.size.width = superview!.frame.width - pasteButtonWidth - currentNumberLabel.frame.origin.x - NSTouchBar.itemGap
//            previousNumberLabel.frame.size = currentNumberLabel.animator().frame.size
//        }
//        frame.size.width = max(superview!.frame.width, frame.width)
//    }
//
